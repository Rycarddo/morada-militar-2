...
function MapSVG() {
  return (
    <svg viewBox="0 0 480 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <line x1="0" y1="120" x2="480" y2="120" stroke="#C4BFB8" strokeWidth="1" />
      <line x1="0" y1="200" x2="480" y2="200" stroke="#C4BFB8" strokeWidth="1" />
      <line x1="0" y1="280" x2="480" y2="280" stroke="#B8B3AB" strokeWidth="1.5" />
      <line x1="0" y1="340" x2="480" y2="340" stroke="#C4BFB8" strokeWidth="1" />

      {/* Street grid - vertical */}
      <line x1="100" y1="0" x2="100" y2="400" stroke="#C4BFB8" strokeWidth="1" />
      <line x1="200" y1="0" x2="200" y2="400" stroke="#B8B3AB" strokeWidth="1.5" />
      <line x1="300" y1="0" x2="300" y2="400" stroke="#C4BFB8" strokeWidth="1" />
      <line x1="380" y1="0" x2="380" y2="400" stroke="#C4BFB8" strokeWidth="1" />
      ...
      <line x1="240" y1="200" x2="80" y2="100" stroke="#E8A020" strokeWidth="1.5" strokeDasharray="6 4" strokeOpacity="0.7" />
      <line x1="240" y1="200" x2="400" y2="100" stroke="#E8A020" strokeWidth="1.5" strokeDasharray="6 4" strokeOpacity="0.7" />
      <line x1="240" y1="200" x2="80" y2="330" stroke="#E8A020" strokeWidth="1.5" strokeDasharray="6 4" strokeOpacity="0.7" />
      <line x1="240" y1="200" x2="420" y2="340" stroke="#E8A020" strokeWidth="1.5" strokeDasharray="6 4" strokeOpacity="0.7" />

      {/* Landmark labels */}
      <rect x="22" y="60" width="110" height="30" rx="2" fill="#D4CEBF" stroke="#A09890" strokeWidth="1" />
      <text x="77" y="80" textAnchor="middle" fill="#1E1A16" fontSize="11" fontFamily="monospace" fontWeight="800">BAMN · 11 min</text>

      <rect x="345" y="60" width="110" height="30" rx="2" fill="#D4CEBF" stroke="#A09890" strokeWidth="1" />
      <text x="400" y="80" textAnchor="middle" fill="#1E1A16" fontSize="11" fontFamily="monospace" fontWeight="800">4° BAvEx · 13 min</text>

      <rect x="22" y="310" width="110" height="30" rx="2" fill="#D4CEBF" stroke="#A09890" strokeWidth="1" />
      <text x="77" y="330" textAnchor="middle" fill="#1E1A16" fontSize="11" fontFamily="monospace" fontWeight="800">Hospital · 13 min</text>

      <rect x="348" y="320" width="105" height="30" rx="2" fill="#D4CEBF" stroke="#A09890" strokeWidth="1" />
      <text x="400" y="340" textAnchor="middle" fill="#1E1A16" fontSize="11" fontFamily="monospace" fontWeight="800">Centro · 15 min</text>
      ...
      <circle cx="240" cy="200" r="18" fill="#E8A020" fillOpacity="0.20">
        ...
        <animate attributeName="fill-opacity" values="0.20;0.06;0.20" dur="2.5s" repeatCount="indefinite" />
      </circle>
    ...
    <svg viewBox="0 0 480 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      {connections.map(([a, b], i) => (
        <line
          ...
          stroke="#7B4F2E" strokeWidth="1" strokeOpacity="0.30"
        />
      ))}
      ...
      {nodes.map((n, i) => (
        <g key={i}>
          <circle cx={n.cx} cy={n.cy} r={n.r * 2.2} fill={n.primary ? "#E8A020" : "#7B4F2E"} fillOpacity={n.primary ? 0.20 : 0.12}>
            <animate
              attributeName="r"
          ...
          <circle cx={n.cx} cy={n.cy} r={n.r} fill={n.primary ? "#E8A020" : "#7B4F2E"} fillOpacity={n.primary ? 0.9 : 0.55} />
          {n.primary && <circle cx={n.cx} cy={n.cy} r={n.r * 0.45} fill="#3A2800" fillOpacity="0.9" />}
        </g>
      ))}
    </svg>
  );
...
const differentials: Differential[] = [
  {
    ...
    distances: [
      ...
      { label: "UFAM / Atacadão", dist: "5 min" },
  ...
  },
  {
    ...
    title: "Mobiliado Completo",
    text: "Apartamento entregue com tudo o que sua família precisa desde o primeiro dia. Móveis planejados, eletrodomésticos e cama — é só chegar e morar.",
    finishes: [
            ...
            >
              ...
              >
                ...
                {diff.visual === "photo" && (
                  <div className="relative w-full h-full min-h-[400px]">
                    ...
                    {/* Badge */}
                    <div className="absolute top-6 left-6 backdrop-blur-sm text-xs font-semibold px-3 py-1.5 rounded-badge tracking-wide"
                      style={{ background: "rgba(139,26,26,0.90)", color: "#ffffff" }}>
                      Mobiliado Completo
                    </div>
                  </div>
                )}
              ...
              >
                ...
                <div className="border-l-[3px] border-wood pl-8 flex flex-col gap-6">
                  <p className="text-[11px] tracking-[0.25em] uppercase text-text-muted font-medium"
                  ...
                  {diff.distances && (
                    <ul className="space-y-2">
                      {diff.distances.map((d) => (
                        <li key={d.label} className="flex items-center gap-3 text-sm text-text-secondary">
                  ...
                  {diff.finishes && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {diff.finishes.map((f) => (
                        ...
                        >
                          <svg viewBox="0 0 24 24" className="w-4 h-4 mb-2" fill="none" stroke="#E8A020" strokeWidth="1.5">
